...
MenuItem MainMenuItems[] = {
	...
	{.General_item_text = "Night", .General_callback = NULL, .General_SubMenuPage = NULL, .List_BoolRadioBox = &ColorMode, .Tiles_Icon = Image_night},
...
MenuItem MoreMenuItems[] = {
	...
	{.General_item_text = "音量进度条窗口demo", .General_callback = ShowIntDataWindow, .General_SubMenuPage = NULL, .List_BoolRadioBox = NULL,.List_IntBox = &OLED_UI_Volume},
